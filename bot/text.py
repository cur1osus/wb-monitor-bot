...
DASHBOARD_HINTS: tuple[str, ...] = (
    ...
    "⚖️ На PRO и PRO+ можно сравнивать от 2 до 5 товаров по ссылкам или артикулам и выбирать режим: дешевле, качество, подарок или без риска.",
...
HELP_TEXT = (
    ...
    "• сравнивать 2-5 товаров на PRO/PRO+\n\n"
    "Как пользоваться:\n"
    ...
    "• для сравнения отправьте 2-5 ссылок/артикулов после нажатия «Сравнить товары»\n\n"
