...
TRACK_ADDED_FIND_CHEAPER_BTN = "🔎 Найти дешевле"
...
FIND_CHEAPER_TO_LIST_BTN = "◀️ К моим товарам"
...
SETTINGS_PRICE_PROMPT = (
    "🎯 Введите желаемую цену (в рублях):\nНапример: 1500 или 1500.50"
)
SETTINGS_PRICE_ERROR = "❌ Некорректная цена. Введите положительное число."
SETTINGS_PRICE_DONE = "✅ Целевая цена для <b>{title}</b> установлена: {price} ₽"
SETTINGS_DROP_PROMPT = "📉 Введите процент падения (например, 10 для 10%):"
SETTINGS_DROP_ERROR = "❌ Некорректный процент. Введите число от 1 до 99."
SETTINGS_DROP_DONE = (
...
REVIEW_ANALYSIS_GROQ_EMPTY = "Не удалось получить результат анализа. Попробуйте позже."
REVIEW_ANALYSIS_GROQ_FORBIDDEN = "Сервис анализа временно недоступен. Попробуйте позже."
